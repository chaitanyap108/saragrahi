...
export default function HomePage(props: HomePageProps) {
  ...
  return (
    <>
      {/* ─── Hero ──────────────────────────────────────────────────────────── */}
      <section className="min-h-[90vh] flex flex-col items-center justify-center px-6 pt-0 pb-8 text-center relative overflow-hidden bg-background">
        ...
        <div className="max-w-3xl mx-auto flex flex-col items-center relative -mt-16 md:-mt-20 lg:-mt-24">
          <Image
            src={hero?.logo || "/logo_with_diacritics.png"}

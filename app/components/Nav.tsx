          ...
          >
            ...
            {servicesOpen && (
              <div className="absolute top-full right-0 pt-3">
                ...
                <Link href="/services#mediation" className="text-xs tracking-[0.18em] uppercase text-muted hover:text-foreground transition-colors duration-200 font-medium">Mediation and Life Consulting</Link>
